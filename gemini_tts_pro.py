...
from PyQt6.QtCore import (
    ...
    QRectF, QRect, QPoint, QPointF
)
from PyQt6.QtGui import (
    QAction, QFont, QColor, QKeySequence, QTextCursor, QBrush, QShortcut, QPixmap, QIcon,
    QPainter, QFontMetrics, QPen
)
...
# ═══════════════════════════════════════════════════════════════
# RESOURCE & ICON MANAGEMENT (EMBEDDED + LOCAL)
# ═══════════════════════════════════════════════════════════════

DEFAULT_APP_ICON_BASE64 = b""""""

def resource_path(name: str) -> Path:
    """Access resources in normal run and PyInstaller one-file/one-folder bundles."""
    try:
...
def get_app_icon() -> QIcon:
    """Returns the application icon, checking disk first then embedded base64 fallback."""
    for fname in ["gemini_tts_pro.ico", "gemini_tts_pro.png", "icon.ico"]:
        p = resource_path(fname)
        if p.exists():
            return QIcon(str(p))
    try:
        pixmap = QPixmap()
        pixmap.loadFromData(base64.b64decode(DEFAULT_APP_ICON_BASE64))
        if not pixmap.isNull():
            return QIcon(pixmap)
    except Exception:
        pass
    if QApplication.instance():
        return QApplication.instance().style().standardIcon(QStyle.StandardPixmap.SP_MediaPlay)
    return QIcon()
...
def get_app_stylesheet(dark_theme: bool = True) -> str:
    ...
    if dark_theme:
        return """
            ...
            QPushButton#btn_new_proj:hover {
                background-color: #b4befe;
                border-color: #89b4fa;
            }
            QPushButton#btn_browse_proj {
                background-color: #a6e3a1;
                color: #11111b;
                font-weight: 900;
                font-size: 16px;
            ...
            QPushButton#btn_browse_proj:hover {
                background-color: #94e28f;
                border-color: #a6e3a1;
            }
            QProgressBar {
...
def apply_dialog_theme(dialog: QDialog, dark_theme: bool = True) -> None:
    """Explicitly applies the crystal-clear theme and custom studio icon to dialogs."""
...
def play_or_open_file(filepath: str) -> bool:
    """Open any audio or document file using the OS system's default media player / application directly.
    No internal audio player is used; on Windows, os.startfile opens the user's default audio player (e.g. Windows Media Player, VLC)."""
...
def clean_arabic_text(text: str, auto_clean: bool = True, remove_diacritics: bool = False) -> str:
    """Normalizes and cleans Arabic text before chunking, expanding honorific ligatures for clear TTS articulation."""
    if not text:
        return ""
    t = text
...
# ═══════════════════════════════════════════════════════════════
# PartsGridWidget — شبكة مربعات الأجزاء التفاعلية (مستوردة من v2.1)
# ═══════════════════════════════════════════════════════════════

class PartsGridWidget(QWidget):
    """شبكة مرسومة بكفاءة تعرض كل الأجزاء في الشاشة وتتكيف مع العدد والمساحة وتدعم التفاعل الفوري."""
    partClicked = pyqtSignal(int)
    COLORS = {
        "pending": QColor("#313244"),
        "processing": QColor("#fab387"),
        "running": QColor("#fab387"),
        "done": QColor("#a6e3a1"),
        "complete": QColor("#a6e3a1"),
        "failed": QColor("#f38ba8"),
        "queued": QColor("#cba6f7"),
    }
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("background:#11111b;border:1px solid #45475a;border-radius:6px;")

    def resizeEvent(self, event):
        super().resizeEvent(event)
        self._rects, _, _ = self._layout()
        self.update()
    ...
    def set_parts(self, total: int, completed: Optional[set] = None, sizes: Optional[Dict[int, int]] = None, statuses: Optional[Dict[int, str]] = None):
        ...
        for i in range(total):
            if i in statuses and statuses[i] in self.COLORS:
                self._states.append(statuses[i])
            elif i in completed:
                self._states.append("done")
            else:
                self._states.append("pending")
        self._sizes = [int(sizes.get(i, 0) or 0) for i in range(total)]
        self._hovered = -1
        self._rects, _, _ = self._layout()
        self.update()

    def set_part(self, index: int, state: str, size_bytes: int = 0):
        if 0 <= index < len(self._states):
            self._states[index] = state if state in self.COLORS else "pending"
            if size_bytes:
                self._sizes[index] = int(size_bytes)
            self._rects, _, _ = self._layout()
            self.update()
    ...
    def state(self, index: int) -> str:
        return self._states[index] if 0 <= index < len(self._states) else "pending"
    ...
    def _layout(self):
        ...
        if n <= 0 or r.width() <= 0 or r.height() <= 0:
            return [], 0, 0
        if n == 1:
            return [QRectF(r)], 1, 1
        ratio = max(0.1, r.width() / max(1, r.height()))
        base = max(1, int(math.ceil(math.sqrt(n * ratio))))
        candidates = []
        for cols in range(max(1, base - 4), min(n, base + 4) + 1):
            rows = math.ceil(n / cols)
            tw = r.width() / cols
            th = r.height() / rows
            score = min(tw, th) - abs(tw - th) * 0.08 - (rows * cols - n) * 0.002
            candidates.append((score, cols, rows))
        if not candidates:
            candidates.append((0, 1, n))
        _, cols, rows = max(candidates)
        tw = r.width() / cols
        th = r.height() / rows
        gap = max(1, min(5, int(min(tw, th) * 0.08)))
        rects = []
        for i in range(n):
            row = i // cols
            col = i % cols
            x = r.left() + col * tw
            y = r.top() + row * th
            rects.append(QRectF(x + gap / 2, y + gap / 2, max(1, tw - gap), max(1, th - gap)))
    ...
    def paintEvent(self, event):
        ...
        self._rects, _, _ = self._layout()
        if not self._rects or len(self._states) == 0:
            painter.setPen(QColor("#94a3b8"))
            painter.drawText(self.rect(), Qt.AlignmentFlag.AlignCenter, "لا توجد أجزاء بعد (قم بتحميل ملف نصي للبدء)")
            return
        min_side = min(self._rects[0].width(), self._rects[0].height())
        font = QFont()
        font.setFamilies(["Segoe UI", "Tahoma", "Arial"])
        font.setBold(True)
        px = max(5, min(72, int(min_side * 0.46)))
        font.setPixelSize(px)
        sample = str(len(self._rects))
        metrics = QFontMetrics(font)
        max_width = max(2, self._rects[0].width() - 4)
        while px > 5 and metrics.horizontalAdvance(sample) > max_width:
            px -= 1
            font.setPixelSize(px)
            metrics = QFontMetrics(font)
        ...
        for i, rect in enumerate(self._rects):
            ...
            color = self.COLORS.get(state, self.COLORS["pending"])
            painter.setBrush(color)
            border = QColor("#f9e2af") if i == self._hovered else QColor("#585b70")
            painter.setPen(QPen(border, 2 if i == self._hovered else 1))
            radius = max(1, min(8, min(rect.width(), rect.height()) * 0.16))
            painter.drawRoundedRect(rect, radius, radius)
            if min(rect.width(), rect.height()) >= 7:
                text_color = QColor("#11111b") if state in ("done", "complete") else QColor("#1e1e2e") if state in ("processing", "running", "queued") else QColor("#f8fafc")
                painter.setPen(text_color)
                painter.drawText(rect, Qt.AlignmentFlag.AlignCenter, str(i + 1))

    def mouseMoveEvent(self, event):
        pos = event.position()
        hovered = self._index_at(pos)
        if hovered != self._hovered:
            ...
            if hovered >= 0:
                ...
                size = self._sizes[hovered]
                tip = f"الجزء {hovered + 1} — {state_names.get(self._states[hovered], self._states[hovered])}"
                if size:
                    tip += f" — {size / 1024:.1f} KB"
                self.setToolTip(tip)
            else:
                self.setToolTip("")
    ...
    def mousePressEvent(self, event):
        ...
        if idx >= 0 and event.button() == Qt.MouseButton.LeftButton:
...
class CheckpointManager:
    ...
    def get_chunk_status(self, chunk_index: int) -> Optional[Dict]:
        with QMutexLocker(self._lock):
            val = self._data.get(str(chunk_index))
            return val if isinstance(val, dict) else None

    def set_total_chunks(self, total: int) -> None:
        with QMutexLocker(self._lock):
            self._data["__meta_total__"] = int(total)
            self._save()

    def get_total_chunks(self) -> int:
        with QMutexLocker(self._lock):
            return int(self._data.get("__meta_total__", 0))
...
class TTSWorkerThread(QThread):
    ...
    def __init__(self, chunks: List[ChunkInfo], model_id: str, voice: str,
        ...
        self._checkpoint.set_total_chunks(len(chunks))
    ...
    def _process_single_chunk(self, chunk: ChunkInfo) -> Tuple[int, bool, str]:
        ...
        while True:
            ...
            if api_key is None:
                ...
                self.log_message.emit(f"[{self._ts()}] ⚠ لا مفتاح متاح — انتظار...", "#89b4fa")
            ...
            try:
                ...
                if is_quota_error(e):
                    ...
                    if kind == QuotaKind.PER_DAY or delay >= 600.0:
                        ...
                        self.log_message.emit(f"[{self._ts()}] 🔄 حظر كوتة ({kind_label}) على {GlobalKeyManager.mask_key(api_key)} — التبديل لمفتاح آخر", "#89b4fa")
                    else:
                    ...
                    if self._adaptive_parallel and self._active_workers > 1:
                        ...
                        self.log_message.emit(f"[{self._ts()}] ⚡ توازي متكيف: تم خفض العمال إلى {self._active_workers}", "#89b4fa")
                        
                    time.sleep(min(3.0, delay if delay < 600.0 else 3.0))
                elif is_retryable_error(e):
                    backoff = min(60, 2 ** attempt)
                    self.log_message.emit(f"[{self._ts()}] ⚠ المقطع {chunk.index + 1} خطأ شبكة — محاولة {attempt} بعد {backoff}ث", "#cba6f7")
                    try:
                        interruptible_sleep(backoff, self._stop_event)
                    except InterruptedError:
                        return (chunk.index, False, "stopped")
                else:
                    self.log_message.emit(f"[{self._ts()}] ⚠ المقطع {chunk.index + 1} محاولة {attempt}/{self._retry_count}: {last_error[:80]}", "#cba6f7")
                    backoff = min(60, 2 ** attempt)
                    try:
                        interruptible_sleep(backoff, self._stop_event)
                    except InterruptedError:
    ...
    def _call_gemini_tts(self, text: str, api_key: str, output_path: str, context_hint: str = "") -> None:
        ...
        if not response or not hasattr(response, "candidates") or not response.candidates:
            raise RuntimeError("استجابة فارغة من خادم Google Gemini (لم يتم إرجاع بيانات صوتية للمقطع)")
        cand = response.candidates[0]
        if hasattr(cand, "finish_reason") and cand.finish_reason and str(cand.finish_reason).upper() in ("SAFETY", "OTHER", "RECITATION", "BLOCKLIST"):
            raise RuntimeError(f"تم حجب أو رفض المقطع بواسطة فلاتر حماية Google Gemini (السبب: {cand.finish_reason})")
        if not hasattr(cand, "content") or not cand.content or not hasattr(cand.content, "parts") or not cand.content.parts or len(cand.content.parts) == 0:
            raise RuntimeError("لم يُرجع الخادم أجزاء صوتية في الاستجابة (قد يحتوي النص على رموز غير مسموحة أو رفض مؤقت من النموذج)")
        audio_data = cand.content.parts[0].inline_data.data
            ...
            with ThreadPoolExecutor(max_workers=self._max_workers) as executor:
                ...
                for future in as_completed(futures):
                    if self._stop_event.is_set():
                        ...
                        self.log_message.emit(f"[{self._ts()}] ⏹ تم إيقاف المعالجة بناءً على أمر المستخدم", "#89b4fa")
                        return
...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self) -> None:
        ...
        # 1. Source Text Group (مشروع جديد واستعراض في صف واحد وأسفلهم مسار الملف بخط وارتفاع بارز)
        ...
        self.new_project_btn.setObjectName("btn_new_proj")
        self.new_project_btn.clicked.connect(self._new_project_action)
        self.new_project_btn.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        self.new_project_btn.setMinimumHeight(44)
        self.new_project_btn.setMaximumHeight(46)
        top_btn_row.addWidget(self.new_project_btn, 1)
        
        self.browse_btn = QPushButton("📂 استعراض واختيار ملف...")
        self.browse_btn.setObjectName("btn_browse_proj")
        ...
        self.browse_btn.setMaximumHeight(46)
        top_btn_row.addWidget(self.browse_btn, 1)
        src_layout.addLayout(top_btn_row)
        
        self.file_path_label = QLineEdit()
        self.file_path_label.setReadOnly(True)
        self.file_path_label.setPlaceholderText("📄 مسار الملف النصي المحمل حالياً (أو انقر استعراض لاختيار ملف)...")
        self.file_path_label.setMinimumHeight(40)
        self.file_path_label.setStyleSheet("font-size: 15px; font-weight: 900; border: 1px solid #89b4fa; border-radius: 6px; padding: 8px 12px;")
        if self._config.source_file:
            self.file_path_label.setText(self._config.source_file)
        src_layout.addWidget(self.file_path_label)
        ...
        self.unblock_all_btn = QPushButton("🔓 فك حظر كل المفاتيح")
        ...
        self.bitrate_combo.addItems([
            "الأصلية المباشرة (WAV - الافتراضي)",
        ...
        # ── Control Rows (موزعة على صفين ونقلت لأسفل الشاشة لسهولة المتابعة والوصول) ──
        ...
        ctrl_row1.addWidget(self.start_btn, 2)
        
        self.pause_btn = QPushButton(UI["pause"])
        self.pause_btn.setObjectName("btn_pause")
        self.pause_btn.setEnabled(False)
        self.pause_btn.clicked.connect(self._toggle_pause)
        ctrl_row1.addWidget(self.pause_btn, 1)
        
        self.stop_btn = QPushButton(UI["stop"])
        self.stop_btn.setObjectName("btn_stop")
        self.stop_btn.setEnabled(False)
        self.stop_btn.clicked.connect(self._stop_processing)
        ctrl_row1.addWidget(self.stop_btn, 1)
        
        ctrl_row2 = QHBoxLayout()
        ctrl_row2.setSpacing(8)
        self.merge_btn = QPushButton("🔀 دمج المتاح")
        self.merge_btn.setObjectName("btn_merge")
        self.merge_btn.clicked.connect(self._merge_available)
        self.merge_btn.setEnabled(False)
        ctrl_row2.addWidget(self.merge_btn, 2)
        
        self.retry_all_btn = QPushButton("🔁 محاولة الفاشلة")
        self.retry_all_btn.setObjectName("btn_retry")
        self.retry_all_btn.clicked.connect(self._retry_all_failed_chunks)
        self.retry_all_btn.setEnabled(False)
        ctrl_row2.addWidget(self.retry_all_btn, 2)
        
        self.open_folder_btn = QPushButton("📂 مجلد الكتاب")
        self.open_folder_btn.clicked.connect(self._open_output_folder)
        ctrl_row2.addWidget(self.open_folder_btn, 1)

        self.open_root_btn = QPushButton("📁 المجلد الرئيسي")
        self.open_root_btn.clicked.connect(self._open_root_output_folder)
        ctrl_row2.addWidget(self.open_root_btn, 1)
        ...
        # ── عرض الأجزاء المزدوج (جدول المقاطع ↔ شبكة الأجزاء التفاعلية v2.1) ──
        view_hdr_row = QHBoxLayout()
        self.toggle_view_btn = QPushButton("📡 تبديل العرض (شبكة / جدول)")
        self.toggle_view_btn.setStyleSheet("background-color: #313244; color: #89b4fa; font-weight: bold;")
        self.toggle_view_btn.clicked.connect(self._toggle_chunks_view)
        view_hdr_row.addWidget(self.toggle_view_btn)
        view_hdr_row.addStretch()
        right_layout.addLayout(view_hdr_row)

        self.right_stack = QStackedWidget()

        # Page 0: Chunks table (7 columns)
        ...
        self.right_stack.addWidget(self.chunks_table)

        # Page 1: PartsGridWidget container (v2.1)
        grid_container = QWidget()
        gc_layout = QVBoxLayout(grid_container)
        gc_layout.setContentsMargins(0, 0, 0, 0)
        
        legend_row = QHBoxLayout()
        for text, color in [("■ مكتمل", "#a6e3a1"), ("■ جارٍ", "#89b4fa"), ("■ فشل", "#f38ba8"), ("■ انتظار", "#313244")]:
            lbl = QLabel(text)
            lbl.setStyleSheet(f"color: {color}; font-weight: bold; font-size: 12px;")
            legend_row.addWidget(lbl)
        legend_row.addStretch()
        gc_layout.addLayout(legend_row)

        self.parts_grid = PartsGridWidget()
        self.parts_grid.partClicked.connect(self._on_part_grid_clicked)
        gc_layout.addWidget(self.parts_grid, 1)
        ...
        right_layout.addLayout(ctrl_row1)
        right_layout.addLayout(ctrl_row2)

        # ضبط سياسات وتناسب أبعاد جميع الأزرار لتكون ثابتة عمودياً (Fixed) ومتناسبة ومنطقية تماماً (28-30px للأزرار العادية، و 34-36px لأزرار التحكم، و 50-52px لزر بدء المعالجة ليكون أكبر مرة ونصف)
        for btn in [self.preview_text_btn, self.preview_voice_btn,
                    self.add_keys_btn, self.validate_keys_btn, self.keys_status_btn, self.unblock_all_btn,
                    self.preview_chunks_btn, self.fetch_models_btn, self.select_models_btn,
                    self.browse_output_btn, self.toggle_view_btn, self.export_log_btn,
                    self.open_folder_btn, self.open_root_btn]:
            if hasattr(self, btn.objectName()) or btn:
                btn.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
                btn.setMinimumHeight(28)
                btn.setMaximumHeight(30)

        for btn in [self.pause_btn, self.stop_btn, self.merge_btn, self.retry_all_btn]:
            btn.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
            btn.setMinimumHeight(34)
            btn.setMaximumHeight(36)

        # جعل زر بدء المعالجة (▶ بدء المعالجة) أكبر مرة ونصف تقريباً (50-52px) ليكون بارزاً وأعلى وضوحاً في أسفل الشاشة
    ...
    def _startup_checks(self) -> None:
        ...
        if self._config.source_file and os.path.exists(self._config.source_file):
            ...
            try:
                out_path = self._config.output_folder if hasattr(self._config, "output_folder") and self._config.output_folder else (self.output_path_input.text().strip() if hasattr(self, "output_path_input") else "")
                base = os.path.splitext(os.path.basename(self._config.source_file))[0]
                clean_name = re.sub(r'[^\w\s-]', '', base).strip().replace(' ', '_') or "project"
                if out_path and clean_name:
                    final_merged = os.path.join(out_path, f"{clean_name}_FINAL.wav")
                    cp_file = os.path.join(out_path, clean_name, f"{clean_name}_checkpoint.json")
                    if os.path.exists(cp_file):
                        cp_mgr = CheckpointManager(cp_file)
                        completed_indices = cp_mgr.get_completed_indices()
                        total_meta = cp_mgr.get_total_chunks()
                        # إذا كان عدد المقاطع المكتملة يساوي إجمالي المقاطع وكان الأخير أكبر من الصفر، فالجلسة السابقة مكتملة تماماً
                        if total_meta > 0 and len(completed_indices) >= total_meta:
                            should_auto_load = False
                        elif os.path.exists(final_merged) and len(completed_indices) > 0:
                            should_auto_load = False
                    elif os.path.exists(final_merged):
                        should_auto_load = False
            except Exception:
                pass
            ...
            if should_auto_load:
                ...
                self._log("🔄 تم تحميل الجلسة السابقة غير المكتملة تلقائياً لاستئناف العمل من حيث توقفت.", "#89b4fa")
            else:
                self._new_project_action()
                self._log("✨ تم فتح الاستوديو بواجهة نظيفة جاهزة لتحويل جديد (لأن الجلسة السابقة مكتملة بنجاح 100%).", "#a6e3a1")
    ...
    def _get_current_voice(self) -> str:
        ...
        if data and str(data).strip():
            clean = re.sub(r'[^a-zA-Z]', '', str(data)).strip().lower()
            if clean:
                return clean
    ...
    def _on_models_fetch_failed(self, error: str) -> None:
        self.fetch_models_btn.setEnabled(True)
        self._update_models_status_label()
        self._log(f"✗ تعذر جلب النماذج: {error}", "#f38ba8")
    ...
    def _new_project_action(self) -> None:
        ...
        if hasattr(self, "parts_grid"):
            self.parts_grid.set_parts(0)
    ...
    def _build_chunks(self) -> List[ChunkInfo]:
        ...
        # استعادة تلقائية لحالة المقاطع من ملف نقطة الاستئناف إن وجد (لإظهار الأجزاء المنجزة أو الفاشلة في جدول المقاطع وشبكة الأجزاء فور التحميل!)
        try:
            out_path = self.output_path_input.text().strip() if hasattr(self, "output_path_input") else ""
            proj_name = self.project_name_input.text().strip() if hasattr(self, "project_name_input") else ""
            if out_path and proj_name:
                cp_file = os.path.join(out_path, proj_name, f"{proj_name}_checkpoint.json")
                if os.path.exists(cp_file):
                    cp_mgr = CheckpointManager(cp_file)
                    cp_mgr.set_total_chunks(len(self._chunks))
                    for c in self._chunks:
                        st = cp_mgr.get_chunk_status(c.index)
                        if st:
                            if st.get("status") == "done" and st.get("file") and os.path.exists(st["file"]):
                                c.status = "done"
                                c.output_file = st["file"]
                                if st.get("elapsed"): c.time_taken = float(st["elapsed"])
                            elif st.get("status") == "failed":
                                c.status = "failed"
                                c.error_msg = st.get("error", "فشل في محاولة سابقة")
        except Exception:
            pass
    ...
    def _preview_voice(self) -> None:
        ...
        def _do():
            try:
                ...
                voice_clean = re.sub(r'[^a-zA-Z]', '', str(voice)).strip().lower() or "kore"
                speech_cfg = types.SpeechConfig(
                    voice_config=types.VoiceConfig(
                        prebuilt_voice_config=types.PrebuiltVoiceConfig(
                            voice_name=voice_clean)))
    ...
    def _start_processing(self, is_auto_retry_round: bool = False) -> None:
        ...
        self.start_btn.setText("⏳ جاري المعالجة...")
    ...
    def _toggle_pause(self) -> None:
        ...
        if self._worker.is_paused():
            ...
            self._log("⏸ تم الإيقاف المؤقت", "#89b4fa")
    ...
    def _stop_processing(self) -> None:
        ...
        reply = QMessageBox.question(self, "تأكيد الإيقاف", UI["confirm_stop"],
                                     QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
        if reply == QMessageBox.StandardButton.Yes:
            self._log("⏹ إيقاف إجباري: جاري قطع كافة خيوط المعالجة فوراً (حد أقصى 5 ثوانٍ)...", "#89b4fa")
            if self._worker:
                self._worker.stop()
                # انتظار انتهاء الخيط بهدوء حتى 4.8 ثوانٍ، وإذا لم ينتهي بسبب اتصال شبكة معلق، يتم إنهاؤه إجبارياً فوراً (Terminate)
                if not self._worker.wait(4800):
                    self._log("⚡ تم قطع وإنهاء خيوط الشبكة المعلقة إجبارياً بعد انقضاء 5 ثوانٍ.", "#f38ba8")
                    try:
                        self._worker.terminate()
                        self._worker.wait(200)
                    except Exception:
            ...
            # إعادة تفعيل جميع الأزرار وزر بدء المعالجة وإعادة ضبط حالته ليكون مستعداً للبدء من جديد فوراً
            self._on_stopped_reset_ui()

    def _on_stopped_reset_ui(self) -> None:
        self._eta_timer.stop()
        self.start_btn.setEnabled(True)
        self.start_btn.setText(UI["start"])
        self.pause_btn.setEnabled(False)
        self.pause_btn.setText(UI["pause"])
        self.stop_btn.setEnabled(False)
        self.merge_btn.setEnabled(any(c.status == "done" for c in self._chunks))
        self.retry_all_btn.setEnabled(any(c.status == "failed" for c in self._chunks))
        self.status_bar_label.setText("تم الإيقاف — جاهز للبدء من جديد")
        self.current_chunk_label.setText("تم الإيقاف بواسطة المستخدم")
        self._log("🔄 تم إعادة تهيئة وتفعيل جميع الأزرار والبرنامج جاهز للبدء من جديد فوراً.", "#a6e3a1")

    def _populate_table(self) -> None:
        self._update_chunk_counter_display()
        if hasattr(self, "parts_grid"):
            sizes = {i: os.path.getsize(c.output_file) if c.output_file and os.path.exists(c.output_file) else 0 for i, c in enumerate(self._chunks)}
            statuses = {i: c.status for i, c in enumerate(self._chunks)}
            completed_set = {i for i, c in enumerate(self._chunks) if c.status == "done"}
            self.parts_grid.set_parts(len(self._chunks), completed_set, sizes, statuses)
    ...
    def _toggle_chunks_view(self) -> None:
        if not hasattr(self, "right_stack"):
            return
        cur = self.right_stack.currentIndex()
    ...
    def _on_part_grid_clicked(self, index: int) -> None:
        if index < 0 or index >= len(self._chunks):
            return
        c = self._chunks[index]
        if c.status == "done" and c.output_file and os.path.exists(c.output_file):
            play_or_open_file(c.output_file)
            self._log(f"🔊 تشغيل المقطع {index + 1}: {os.path.basename(c.output_file)}", "#a6e3a1")
        else:
            dlg = QDialog(self)
            apply_dialog_theme(dlg, self._config.dark_theme)
            dlg.setWindowTitle(f"📝 نص المقطع {index + 1} ({c.status})")
            dlg.resize(640, 420)
            v = QVBoxLayout(dlg)
            info = QLabel(f"المقطع {index + 1} من {len(self._chunks)} | الأحرف: {c.char_count} | الحالة: {c.status}")
            info.setStyleSheet("font-weight: bold; color: #89b4fa; font-size: 13px;")
            v.addWidget(info)
            txt_edit = QPlainTextEdit()
            txt_edit.setReadOnly(True)
            txt_edit.setPlainText(c.text)
            txt_edit.setFont(QFont("Tahoma", 11))
            v.addWidget(txt_edit, 1)
            hb = QHBoxLayout()
            copy_btn = QPushButton("📋 نسخ النص")
            copy_btn.clicked.connect(lambda: QApplication.clipboard().setText(c.text))
            hb.addWidget(copy_btn)
            if c.status == "failed":
                retry_btn = QPushButton("🔁 إعادة محاولة هذا المقطع")
                retry_btn.setStyleSheet("background-color: #f38ba8; color: #11111b; font-weight: bold;")
                retry_btn.clicked.connect(lambda: (dlg.accept(), self._retry_single_chunk(index)))
                hb.addWidget(retry_btn)
            hb.addStretch()
    ...
    def _on_chunk_started(self, idx: int) -> None:
        if idx < len(self._chunks):
            ...
            self._update_chunk_counter_display()
            if hasattr(self, "parts_grid"): self.parts_grid.set_part(idx, "processing");
            if hasattr(self, "chunks_table") and idx < self.chunks_table.rowCount(): self.chunks_table.scrollToItem(self.chunks_table.item(idx, 0))
    ...
    def _on_chunk_done(self, idx: int, filepath: str) -> None:
        if idx < len(self._chunks):
            ...
            self._update_chunk_counter_display()
            if hasattr(self, "parts_grid"): self.parts_grid.set_part(idx, "done", os.path.getsize(filepath) if os.path.exists(filepath) else 0);
    ...
    def _on_chunk_failed(self, idx: int, error: str) -> None:
        if idx < len(self._chunks):
            ...
            c.error_msg = error
            self._update_chunk_counter_display()
            if hasattr(self, "parts_grid"): self.parts_grid.set_part(idx, "failed");
    ...
    def _retry_single_chunk(self, chunk_idx: int) -> None:
        ...
        def _do_retry():
            worker = TTSWorkerThread([chunk], self._get_current_model_id(), self._get_current_voice(),
    ...
    def _on_finished(self, msg: str) -> None:
        ...
        if failed_chunks and not self._closing and self._current_retry_round < self._config.max_retry_rounds:
            ...
            self._log(f"⚡ [جولة الإعادة التلقائية {self._current_retry_round}/{self._config.max_retry_rounds}] تم اكتشاف {len(failed_chunks)} مقطع فاشل. جاري إعادة محاولتها تلقائياً الآن...", "#89b4fa")
        ...
        if len(completed) == len(self._chunks) and len(completed) > 0:
            ...
            self._log(f"⚠️ {msg} (تبقت {len(failed_chunks)} مقاطع فاشلة بعد اكتمال {self._current_retry_round} جولات إعادة)", "#cba6f7")

    def _trigger_auto_shutdown(self) -> None:
        self._log("⚠️ تم تفعيل الإيقاف التلقائي للنظام بعد اكتمال المشروع — بدء العد التنازلي (60 ثانية)...", "#89b4fa")
    ...
    def _on_log_message(self, msg: str, color: str) -> None:
        if color.lower() in ("#fab387", "#ffc107", "#f9e2af", "#ffd700", "#ffff00", "#ffa500", "yellow", "orange"):
            color = "#89b4fa"
        self._log(msg, color)
    ...
    def _merge_available(self) -> None:
        ...
        if not files:
            QMessageBox.information(self, "دمج المقاطع", "لا توجد مقاطع صوتية مكتملة للدمج حالياً.")
            return
        if len(files) == len(self._chunks) and len(files) > 0:
            self._merge_all_finalize()
            return
        if len(files) < 2:
            QMessageBox.information(self, "دمج المقاطع", "تحتاج إلى مقطع مكتمل واحد على الأقل للدمج الجزئي.")
            return
        project_name = self.project_name_input.text().strip()
    ...
    def _merge_all_finalize(self) -> None:
        files = self._get_completed_wav_files()
        if not files:
            self._log("ℹ️ لا توجد ملفات مكتملة للدمج النهائي", "#89b4fa")
            return
        project_name = self.project_name_input.text().strip()
        output_dir_chunks = os.path.join(self.output_path_input.text().strip(), project_name)
        output_final = os.path.join(self.output_path_input.text().strip(), f"{project_name}_FINAL.wav")
    ...
    def _log(self, message: str, color: str = "#6c7086") -> None:
        if self._closing:
            return
        # حظر واستبدال أي لون أصفر أو برتقالي في ألوان السجل نهائياً بناءً على توجيه المستخدم لراحة العين
        if color.lower() in ("#fab387", "#ffc107", "#f9e2af", "#ffd700", "#ffff00", "#ffa500", "yellow", "orange"):
            color = "#89b4fa"
        clean_msg = message.strip()
        if not clean_msg.startswith("["):
            ts = datetime.now().strftime("%H:%M:%S")
            formatted_msg = f"[{ts}] {clean_msg}"
        else:
...
class WelcomeSplashScreen(QDialog):
    """شاشة ترحيب تفاعلية متحركة تعرض ميزات الإصدار الرابع وتتقدم بسلاسة نحو النافذة الرئيسية."""
    def __init__(self, parent=None, is_standalone=False):
        super().__init__(parent)
        ...
        container.setStyleSheet(
            "QFrame { background-color: #11111b; border: 2px solid #89b4fa; border-radius: 16px; }"
        ...
        # Features frame
        feat_frame = QFrame()
        feat_frame.setStyleSheet("QFrame { background-color: #181825; border: 1px solid #313244; border-radius: 10px; padding: 6px; }")
        ...
        features = [
            "🚀 محرك توليد فائق السرعة مع المعالجة الذاتية الفورية لأخطاء 400 Developer Instruction.",
            "🎙️ كتالوج أصوات مصنف (30 صوت) مع أنماط إلقاء درامية تمثل الأحاسيس والمواقف للروايات.",
            "📡 شاشة أجزاء تفاعلية ملونة (PartsGridWidget) متزامنة لحظياً وتدعم التكبير والتصغير التلقائي.",
            "🔄 نظام توازي متكيف (Adaptive Parallel) ودوران ذكي على مفاتيح API والحظر لمدة 10 دقائق فقط.",
            "📁 عزل كامل للمجلدات لكل كتاب مع دمج مباشر للمخرجات وتقسيمها بمرونة عالية، ونقاط فحص ذاتية."
        ]
        for f in features:
            fl = QLabel(f)
            fl.setStyleSheet("color: #cdd6f4; font-size: 12px;")
            fl.setWordWrap(True)
        ...
        # Progress and status
        self.status_lbl = QLabel("⚡ جاري تهيئة بيئة الاستوديو والتحقق من مكتبات النظام...")
        self.status_lbl.setStyleSheet("color: #fab387; font-weight: bold; font-size: 13px;")
        ...
        self.progress.setStyleSheet(
            "QProgressBar { background-color: #313244; border: 1px solid #45475a; border-radius: 6px; height: 18px; text-align: center; color: #ffffff; font-weight: bold; }"
        ...
        self.skip_btn = QPushButton("🚀 دخول للاستوديو الآن" if not is_standalone else "✔ إغلاق الشاشة")
        self.skip_btn.setStyleSheet("background-color: #89b4fa; color: #11111b; font-weight: bold; padding: 8px 20px; border-radius: 6px; font-size: 13px;")
        ...
        if not is_standalone:
            ...
            self.status_lbl.setText("✨ جميع الميزات والقدرات مفعلة وجاهزة للعمل بنسبة 100%")

    def _on_timer(self):
        self._step += 2
        self.progress.setValue(self._step)
        if self._step == 20:
            self.status_lbl.setText("🔐 جاري فحص وتحميل مفاتيح API وكوتة النماذج اليومية...")
        elif self._step == 46:
            self.status_lbl.setText("🎙️ جاري تهيئة كتالوج الـ 30 صوت المصنف وتحميل العينات الصوتية...")
        elif self._step == 74:
            self.status_lbl.setText("🎨 جاري بناء شاشة الأجزاء التفاعلية وتهيئة استوديو الإنتاج...")
        elif self._step >= 100:
            self._timer.stop()
            self.status_lbl.setText("✨ اكتمل إعداد الاستوديو! جاري فتح النافذة الرئيسية...")
...
def main() -> None:
    ...
    if sys.platform == "win32":
        try:
            import ctypes
            ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(f"Gemini.TTS.Pro.Studio.{APP_VERSION}")
        except Exception:
            pass
